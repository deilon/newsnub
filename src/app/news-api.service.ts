...
export class NewsApiService {
  ...
  initArticles(category: string, page: number, pageSize: number) {
      return this.http.get('https://newsapi.org/v2/top-headlines?category=' + category +'&page='+page+'&pageSize='+pageSize+'&country=us&apiKey='+this.api_key);
  }
